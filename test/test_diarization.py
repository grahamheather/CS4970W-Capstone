...
def test_split_by_speaker_normal(generate_audio_files):
	result, means, covariances = diarization.split_by_speaker(path.join(get_test_recording_dir(), "diarization_normal.wav"))
...
def test_split_by_speaker_noise(generate_audio_files):
	result, means, covariances = diarization.split_by_speaker(path.join(get_test_recording_dir(), "diarization_noise.wav"))
...
def test_split_by_speaker_single(generate_audio_files):
	result, means, covariances = diarization.split_by_speaker(path.join(get_test_recording_dir(), "diarization_single.wav"))
...
def test_split_by_speaker_single_noise(generate_audio_files):
	result, means, covariances = diarization.split_by_speaker(path.join(get_test_recording_dir(), "diarization_single_noise.wav"))
